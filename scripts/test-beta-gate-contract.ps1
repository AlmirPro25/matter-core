...
foreach ($requiredText in @(
    ...
    "test-status-triad-contract.ps1",
    "test-status-triad-history-contract.ps1",
    "export-status-triad-trend-report.ps1",
    "export-status-triad-health.ps1",
    "test-status-triad-health-contract.ps1",
    "test-frontier-simulation-quality-contract.ps1",
    "run-performance-gate.ps1",
    "test-performance-gate-contract.ps1",
    "MATTER_PERFORMANCE_ITERATIONS",
    "MATTER_PERFORMANCE_ENFORCE_DRIFT",
...
$orderedMarkers = @(
    ...
    "test status triad contract",
    "test status triad history contract",
    "export status triad trend report",
    "export status triad health",
    "test status triad health contract",
    "test frontier simulation quality contract",
    "run performance gate",
    "test performance gate contract",
...
[ordered]@{
    ...
    checked = @(
        ...
        "package frontier simulation-quality performance checksum install site beta workflow contracts included",
