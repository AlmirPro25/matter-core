...
function Copy-RequiredPackageFiles {
    ...
    $pairs = @(
        ...
        @("scripts\test-release-artifact-checksums-contract.ps1", "scripts\test-release-artifact-checksums-contract.ps1"),
        @("scripts\test-release-zip-installer-contract.ps1", "scripts\test-release-zip-installer-contract.ps1"),
        @("scripts\diagnose-local-install.ps1", "scripts\diagnose-local-install.ps1"),
        @("scripts\install-release-local.ps1", "scripts\install-release-local.ps1"),
        @("scripts\install-release-zip.ps1", "scripts\install-release-zip.ps1"),
        @("scripts\uninstall-local.ps1", "scripts\uninstall-local.ps1"),
        @("scripts\build-release-package.ps1", "scripts\build-release-package.ps1"),
        @("scripts\export-release-artifact-checksums.ps1", "scripts\export-release-artifact-checksums.ps1"),
        @("scripts\verify-release-artifact-checksums.ps1", "scripts\verify-release-artifact-checksums.ps1"),
