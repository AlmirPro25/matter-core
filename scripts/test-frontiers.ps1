...
$demos = @(
    ...
    @{ File = "neuromorphic_demo.matter";  Name = "Neuromorphic (Hardware SNN)";      Desc = "Rede neural baseada em Spikes e hardware" }
...
if ($anyFail) {
    ...
    Write-Host "[SUCCESS] Todos os paradigmas fisicos e biologicos foram validados!" -ForegroundColor Green
    exit 0
}
